...
evmc::Result Host::execute_message(const evmc_message& msg_in) noexcept
{
    ...
    // EIP-8037: the top-level (depth 0) NEW_ACCOUNT state charge, applied after the EIP-7702
    // authorizations and before the value transfer or any opcode, evaluated against the
    // pre-transfer recipient state.
