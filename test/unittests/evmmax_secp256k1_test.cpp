...
TEST(evmmax, secp256k1_pt_add_inf)
{
    ...
    EXPECT_EQ(add_to_affine(p1, inf), p1);
    EXPECT_EQ(add_to_affine(inf, p1), p1);
    EXPECT_EQ(add_to_affine(inf, inf), inf);
}
...
TEST(evmmax, secp256k1_pt_add)
{
...

    {
        ...
        EXPECT_EQ(add_to_affine(p1, p2), e);
    }
    {
        ...
        EXPECT_EQ(add_to_affine(p1, p1), e);
    }
    {
        ...
        EXPECT_EQ(add_to_affine(p1, p3), e);
    }
    {
        ...
        EXPECT_EQ(add_to_affine(p1, p4), e);
    }
}
