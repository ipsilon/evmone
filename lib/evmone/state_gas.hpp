...
///
/// REVIEW: "regular gas" is our term; EIP-8037 says execution gas throughout and never uses
/// "regular". The spec's word is already taken here: TransactionProperties::execution_gas_limit
/// is gas_limit - intrinsic, i.e. the regular budget and the reservoir together.
struct StateGas
{
